...
import { createUserWithEmailAndPassword, updateProfile, getIdToken, reload } from "firebase/auth";
    ...
    <div className="min-h-screen bg-gray-50 pt-28 pb-10 px-4">
      <div className="max-w-md mx-auto bg-white rounded-xl shadow p-6">
        ...
        <p className="text-sm text-gray-600 mt-4 text-center">
          ¿Ya tienes cuenta? {" "}
          <Link href="/login" className="text-indigo-600 hover:underline">Iniciar sesión</Link>
        </p>
      </div>
    </div>
  );
